...
export default function Home() {
  ...
  useEffect(() => {
    api.get("products/")
      .then((res) => {
        // FIX: paginated response shape is { count, next, previous, results }
        const raw = res.data.results ?? res.data;
        const all = raw.map((p, i) => normaliseProduct(p, i));
    ...
    <main className="home">
      ...
      <section className="hero" ref={heroRef}>
        ...
        <div className="hero__content">
          ...
          <h1 className="hero__heading">
            <span className="hero-word" style={{ animationDelay: "0.1s" }}>IN</span>{" "}
            <span className="hero-word" style={{ animationDelay: "0.25s" }}>YOUR</span>{" "}
            <span className="hero-word hero-word--amber" style={{ animationDelay: "0.4s" }}>ELEMENT.</span>
          </h1>
          <p className="hero__sub" style={{ animationDelay: "0.65s" }}>
            Gear engineered for the Himalayas. Built for every summit, every trail, every adventure.
          </p>
          <div className="hero__ctas" style={{ animationDelay: "0.85s" }}>
            <Link to="/womens" className="btn btn-primary">Shop Women's</Link>
            <Link to="/mens" className="btn btn-secondary">Shop Men's</Link>
          </div>
        </div>
        <div className="hero__mountain-bottom">
          <svg viewBox="0 0 1440 120" preserveAspectRatio="none" fill="none">
            <path d="M0 120L180 30L360 80L540 10L720 60L900 20L1080 70L1260 25L1440 55V120H0Z" fill="#FAF7F2"/>
          </svg>
        </div>
      </section>
        ...
        <div className="container">
          <div className="pills-scroll">
            {categories.map((cat, i) => (
              <button key={cat} className="pill reveal" style={{ transitionDelay: `${i * 60}ms` }}>
                {cat}
              </button>
            ))}
          </div>
        ...
        <div className="container">
          <div className="section-header reveal">
            ...
            <div className="heading-reveal">
              <h2 className="section-heading heading-reveal-inner">Gear That Goes Further</h2>
            </div>
          </div>
          {loading ? (
          ...
          <div className="section-cta reveal">
            <Link to="/mens" className="btn btn-outline">View All Products</Link>
          </div>
        </div>
      </section>
      ...
      <div className="mountain-divider-green">
        <svg viewBox="0 0 1440 80" preserveAspectRatio="none" fill="none">
          <path d="M0 80L240 20L480 55L720 5L960 45L1200 15L1440 50V80H0Z" fill="#1B4332"/>
        </svg>
      </div>
      ...
      <section className="promise-banner">
        <div className="container">
          <div className="promise-banner__inner">
            <div className="promise-banner__locator reveal-scale" style={{ transitionDelay: "0.1s" }}>
              ...
              <div className="promise-banner__map-content">
                <span className="section-label" style={{ color: "rgba(255,255,255,0.6)" }}>Store Locator</span>
                <h2 className="section-heading light">Less Waste.<br/>More Adventure.</h2>
                <p>Every piece we make is built to last, repaired when it wears, and renewed before it retires. Because the mountains deserve better.</p>
            ...
            <div className="promise-banner__visual reveal-scale" style={{ transitionDelay: "0.15s" }}>
              ...
              <svg viewBox="0 0 400 400" fill="none">
                ...
                <text x="200" y="215" textAnchor="middle" fill="rgba(217,119,6,0.8)"
                  fontFamily="Playfair Display" fontSize="12" letterSpacing="3">SUMMIT</text>
              </svg>
            </div>
          </div>
        </div>
      ...
      <section className="ugc-section">
        <div className="container">
          <div className="ugc-header reveal">
            ...
            <div className="heading-reveal">
              <h2 className="section-heading heading-reveal-inner">The Community Summit</h2>
            </div>
          ...
          <div className="ugc-grid">
            {[
              ...
              <div key={i} className="ugc-item reveal"
      ...
      <section className="more-products">
        <div className="container">
          <div className="section-header reveal">
            ...
            <div className="heading-reveal">
              <h2 className="section-heading heading-reveal-inner">Gear You May Like</h2>
            </div>
          </div>
      ...
      <section className="cta-banner reveal-scale">
        ...
        <div className="container">
          <div className="cta-banner__inner">
            ...
            <h2>Every Trail Starts<br/>with the Right Gear.</h2>
        ...
        <div className="container">
          <div className="home-chat-inner reveal">
            <div className="home-chat-text">
              ...
              <div className="heading-reveal">
                <h2 className="section-heading heading-reveal-inner">Not Sure What You Need?</h2>
              </div>
              <p>
                Our mountain experts are here to help — from layering systems to summit packs.
                Tell us your trail, and we&apos;ll build your kit.
              </p>
