      ...
      <main className="product-details-page">
        <div className="container">
          <div className="product-details-missing">
            ...
            <p>
              We could not load this product. Please open it again from a
              collection page.
            </p>
        ...
        <div className="container">
          ...
          <div className="product-details-reviews-layout">
            ...
            <div className="product-details-review-list">
              {reviewsLoading && (
                <p className="product-review-loading">Loading reviews…</p>
              )}
              {reviewsError && (
                <p className="product-review-error">{reviewsError}</p>
              )}
