...
function WriteReview({ onSubmit, displayName }) {
          ...
          <div className="reviews-switch-card reveal">
            ...
            <div className="reviews-switch-content">
              {activeReviewPanel === "share" ? (
                <WriteReview onSubmit={handleReviewSubmit} displayName={displayName} />
              ) : (
                <div>
                  <div className="reviews-upload-cta">
                    <div>
                      ...
                      <p className="reviews-upload-cta__copy">
                        Upload your product review so other trekkers can choose better gear.
                      </p>
                    </div>
                  ...
                  {reviewsLoading && (
                    <p style={{ color: "var(--color-text-secondary)", padding: "2rem 0" }}>Loading reviews…</p>
                  )}
                  {reviewsError && (
                    <p style={{ color: "var(--color-text-danger)", padding: "1rem 0" }}>{reviewsError}</p>
                  )}
                  ...
                  <div className="reviews-grid reviews-grid--switch">
                    {reviews.map((r, i) => (
                      <div key={r.id} className="review-card reveal"
